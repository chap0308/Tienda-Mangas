...
class Email {
    ...
    public function enviarConfirmacion() {
        ...
        $contenido = '<html>';
        $contenido .= "<p><strong>Hola " . $this->nombre .  "</strong> Has Creado tu cuenta en Teikoku Mangas, solo debes confirmarla presionando el siguiente enlace</p>";
    ...
    public function enviarInstrucciones() {
        ...
        $mail->SMTPAuth = true;
        $mail->Port = 2525;
        $mail->Username = '3b8b81b355b739';
        $mail->Password = '9b59d51ee0dbce';
